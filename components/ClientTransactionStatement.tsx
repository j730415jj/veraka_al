...
export default function ClientTransactionStatement({ operations, clients, userRole, userIdentifier }: Props) {
  ...
  const filteredData = useMemo(() => {
    return operations.filter(op => {
      ...
      return isDateMatch && isClientMatch && isBranchMatch && isTypeMatch;
    }).sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
  }, [operations, startDate, endDate, selectedClientName, selectedBranch, viewType]);
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sticky top-4 border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
               ...
               <select value={selectedClientName} onChange={(e) => setSelectedClientName(e.target.value)} className="w-full p-2 border rounded text-base font-bold text-blue-800">
